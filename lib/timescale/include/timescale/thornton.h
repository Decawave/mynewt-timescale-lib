...
#ifndef THORNTON_INCLUDE
#define THORNTON_INCLUDE

#include <stdint.h>
#include <stdlib.h>

typedef struct _thornton_status_t{
    uint16_t NotPositiveDefinitive:1;
}thornton_status_t;

thornton_status_t thornton(double UP[], double DP[], double UQ[], double DQ[], double A[], double S[], uint16_t n);
